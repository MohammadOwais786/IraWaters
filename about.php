                            ...
                            <div class="row">
                                <form action="about.php" method="post">
                                    ...
                                    <div class="form-group col-md-12 text-center">
                                        <input type="submit" class="btn btn-primary btn-lg " href="images/Ira_Profile_2016.pdf" download="Ira_Profile.pdf" value="Download">
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="core-features">
                    ...
                    <div class="grid2" style=" background-color:#13c0d7">
                        <div class="core-f service-heading">
                            ...
                            <p style="color:#fff">We started Ira with an aim to make water available through water conservation.</p>
                            <p style="color:#fff">We have four objectives till year 2020 that guide our work</p>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="core">
                                        <i class="icon-circle-check to-animate-2"></i>
                                        <div class="fh5co-post to-animate">
                                            <p>To improve groundwater table by recharging 50,000 borewells in India</p>
                                        </div>
                                    </div>
                                    <div class="core">
                                        <i class="icon-circle-check to-animate-2"></i>
                        ...
                        <div class="col-md-4">
                            <div class="feature-left " data-animate-effect="fadeInLeft">
                                <div class="feature-copy">
                                    ...
                                    <h3 style="font-size:20px">Attitude</h3>
