...
<body>
    ...
    <div id="page">
        ...
        <div class="page-inner">
            ...
            <div id="gtco-header" data-section="home" class="gtco-cover gtco-cover-sm header-fixed " role="banner" style="background-image:url('../images/wideImages/jobs.jpg');" data-stellar-background-ratio="0.5">
            ...
            <div class="gtco-section border-bottom" id="how-it-works" data-section="how-it-works">
                <div class="gtco-container">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1 service-heading" ><p>If you’d like to join us but don’t see a role that’s right for you then we would like to hear from you. <br/>Email us at <span style="color: #92c73e"><em>info@irawater.com </em></span>with subject “Explore working with Ira” and tell us a bit about yourself.</p></div>
                    </div>
                </div>
            </div>
            ...
            <div class="gtco-section gtco-gray-bg">
                <div class="gtco-container">
                    <div class="row">
                        <div class="col-md-12">
                            <span class="service-heading"><h2 class="text-center">Enter Your Details</h2></span>
                            <form action="jobs.php" method="POST" enctype="multipart/form-data" style="padding-top: 2em" data-toggle="validator">
                                <div class="col-md-6">
                                    ...
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" id="subject" class="form-control" placeholder="Applying for <Job Title>" required>
                                        </div>
                                    </div>
                                    <label class="btn btn-default btn-file">
                                        Upload Resume<input type="file" style="display:none;" required>
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <div class="row form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="message" id="message" cols="30" rows="7" class="form-control" placeholder="Tell us Why You Want to Join Us?" required></textarea>
                                        </div>
                                    </div>
